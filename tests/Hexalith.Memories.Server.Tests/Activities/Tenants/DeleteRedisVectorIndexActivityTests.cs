// <copyright file="DeleteRedisVectorIndexActivityTests.cs" company="ITANEO">
...
public class DeleteRedisVectorIndexActivityTests
{
    [Fact]
    public async Task RunAsync_ShouldReturnTrue()
    {
        ...
        ILogger<DeleteRedisVectorIndexActivity> logger = Substitute.For<ILogger<DeleteRedisVectorIndexActivity>>();
        ...
        DeleteRedisVectorIndexActivity activity = new(redis, logger);
