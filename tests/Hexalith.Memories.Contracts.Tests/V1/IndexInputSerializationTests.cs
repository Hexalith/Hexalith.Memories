...
public class IndexInputSerializationTests
{
    ...
    public void RoundTrip_AllFieldsPopulated_ShouldProduceIdenticalJson()
    {
        ...
        IndexInput? deserialized = JsonSerializer.Deserialize<IndexInput>(json1, MemoriesJsonContext.Options);
    ...
    public void RoundTrip_NullableCausationIdNull_ShouldSerializeCorrectly()
    {
        ...
        IndexInput? deserialized = JsonSerializer.Deserialize<IndexInput>(json, MemoriesJsonContext.Options);
