...
public sealed partial class CiTestInventoryTests
{
    ...
    public void CiWorkflow_PinsDisposableClusterDeploymentVerificationJob()
    {
        ...
        verifier.ShouldContain("Invoke-DisposableOpenBaoBootstrap");
        verifier.ShouldContain("Confirm-UnmodifiedOpenBaoSecretStores");
        verifier.ShouldContain("production-deployment-openbao.ps1");
        verifier.ShouldContain("openbao-bootstrap.json");
        ...
        openBao.ShouldContain("hexalith/memories/runtime");
        openBao.ShouldContain("hexalith/memories/access-telemetry");
        openBao.ShouldContain("hexalith-memories-runtime");
        openBao.ShouldContain("hexalith-memories-access-telemetry");
        openBao.ShouldContain("tls_min_version = \"tls12\"");
        openBao.ShouldNotContain("bao server -dev");
        verifier.ShouldContain("OpenBaoPinnedImage");
        verifier.ShouldNotContain("$script:OpenBaoImagePin = $env:OPENBAO_IMAGE");
        verifier.ShouldContain("access-telemetry-secrets/access-telemetry-marker-key");
        verifier.ShouldContain("verification-access-telemetry-marker");
