...
public static class EvidencePacketViewMapping
{
    ...
    [
        ...
        new("trust.freshness", "EvidencePacket.Metadata.Freshness / EvidencePacket.Sources[].Freshness", EvidenceDisplay.FreshnessUnavailable),
        ...
        new("sources.timestamp", "EvidencePacket.Sources[].Timestamp", "timestamp unavailable"),
        new("sources.freshness", "EvidencePacket.Sources[].Freshness", EvidenceDisplay.FreshnessUnavailable),
