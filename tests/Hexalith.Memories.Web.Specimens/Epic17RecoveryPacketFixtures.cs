// <copyright file="Epic17RecoveryPacketFixtures.cs" company="ITANEO">
...
/// </summary>
public static class Epic17RecoveryPacketFixtures
{
    /// <summary>A confident, complete answer that needs no recovery action.</summary>
    public static EvidencePacket Supported() => Epic17EvidencePacketFixtures.CompletePacket();

    /// <summary>An answer exists but backend health is degraded, so the answer is conflicting.</summary>
    public static EvidencePacket ConflictingViaDegraded() => Epic17EvidencePacketFixtures.DegradedPacket();
    ...
    {
        EvidencePacket packet = Epic17EvidencePacketFixtures.CompletePacket();
        return packet with
        {
    ...
    public static EvidencePacket NoMatch() => Epic17EvidencePacketFixtures.EmptyPacket();

    /// <summary>Stale memory with sources present.</summary>
    public static EvidencePacket StaleMemory() => Epic17EvidencePacketFixtures.StalePacket();

    /// <summary>Weak evidence with sources present.</summary>
    public static EvidencePacket Weak() => Epic17EvidencePacketFixtures.WeakPacket();

    /// <summary>Partial evidence maps to insufficient support.</summary>
    public static EvidencePacket InsufficientFromPartial() => Epic17EvidencePacketFixtures.PartialPacket();
    ...
    {
        EvidencePacket packet = Epic17EvidencePacketFixtures.WeakPacket();
        return packet with
        {
    ...
    {
        EvidencePacket packet = Epic17EvidencePacketFixtures.StalePacket();
        return packet with
        {
            OmittedDetails = new EvidencePacketOmittedDetails(
                OmittedCount: 4,
    ...
    {
        EvidencePacket packet = Epic17EvidencePacketFixtures.UnauthorizedPacket();
        return packet with
        {
            Recovery =
            [
    ...
    {
        EvidencePacket packet = Epic17EvidencePacketFixtures.CompressedPacket();
        return packet with
        {
            Recovery =
            [
