// <copyright file="ValidateServerAuthenticationOptions.cs" company="ITANEO">
...
/// <summary>Validates <see cref="MemoriesServerAuthenticationOptions"/> at startup.</summary>
public sealed class ValidateServerAuthenticationOptions : IValidateOptions<MemoriesServerAuthenticationOptions>
{
    /// <inheritdoc />
    public ValidateOptionsResult Validate(string? name, MemoriesServerAuthenticationOptions options)
    {
