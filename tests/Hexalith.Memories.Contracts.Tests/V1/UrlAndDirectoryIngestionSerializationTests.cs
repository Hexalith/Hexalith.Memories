...
/// <summary>Story 6.1 Task 7.10 — serialization round-trips for all new Contracts/V1 records via MemoriesJsonContext.Options.</summary>
public class UrlAndDirectoryIngestionSerializationTests
{
    ...
    public void UrlFetchResult_RoundTrips()
    {
        ...
        string json = JsonSerializer.Serialize(original, MemoriesJsonContext.Options);
        UrlFetchResult? back = JsonSerializer.Deserialize<UrlFetchResult>(json, MemoriesJsonContext.Options);
    ...
    public void UrlIngestionRequest_RoundTrips()
    {
        ...
        string json = JsonSerializer.Serialize(original, MemoriesJsonContext.Options);
        UrlIngestionRequest? back = JsonSerializer.Deserialize<UrlIngestionRequest>(json, MemoriesJsonContext.Options);
    ...
    public void UrlIngestionResponse_RoundTrips()
    {
        ...
        string json = JsonSerializer.Serialize(original, MemoriesJsonContext.Options);
        UrlIngestionResponse? back = JsonSerializer.Deserialize<UrlIngestionResponse>(json, MemoriesJsonContext.Options);
    ...
    public void DirectoryIngestionRequest_RoundTrips()
    {
        ...
        string json = JsonSerializer.Serialize(original, MemoriesJsonContext.Options);
        DirectoryIngestionRequest? back = JsonSerializer.Deserialize<DirectoryIngestionRequest>(json, MemoriesJsonContext.Options);
    ...
    public void DirectoryIngestionOutcome_RoundTrips()
    {
        ...
        string json = JsonSerializer.Serialize(original, MemoriesJsonContext.Options);
        DirectoryIngestionOutcome? back = JsonSerializer.Deserialize<DirectoryIngestionOutcome>(json, MemoriesJsonContext.Options);
    ...
    public void BatchStatusResponse_RoundTrips()
    {
        ...
        string json = JsonSerializer.Serialize(original, MemoriesJsonContext.Options);
        BatchStatusResponse? back = JsonSerializer.Deserialize<BatchStatusResponse>(json, MemoriesJsonContext.Options);
    ...
    public void SkippedFile_RoundTrips()
    {
        ...
        string json = JsonSerializer.Serialize(original, MemoriesJsonContext.Options);
        SkippedFile? back = JsonSerializer.Deserialize<SkippedFile>(json, MemoriesJsonContext.Options);
