...
### DW 27.3-CR42 - the portable purge checkpoint does not overlap purge and writes
  ...
  - ID: 27.3-CR42
  - Status: open
  - Evidence: Story 27.2's `FiveHundredComponentOperationsWhilePurgeRuns_PreserveNewerRecordsAndAtomicPairs` starts the purge first, and the in-memory store never yields before the subsequent write tasks are created.
  - Source story: 27-3-production-adapter-and-deployment-profile (code review 2026-07-29, chunk 1 of 3)
...
### DW 27.3-CR43 - the admission checkpoint measures capacity rather than 250 events per second
  ...
  - ID: 27.3-CR43
  - Status: open
  - Evidence: Story 27.2's `AdmissionAt250EventsPerSecond_IsByteBoundedAndDropsNewestAtQueueFull` performs 500 immediate sequential enqueues without elapsed-time measurement, producer concurrency, or rate control.
  - Source story: 27-3-production-adapter-and-deployment-profile (code review 2026-07-29, chunk 1 of 3)
  - Target artifact: tests/Hexalith.Memories.IntegrationTests/Telemetry/AccessTelemetryLifecycleIntegrationCheckpointTests.cs
...
### DW 27.3-CR44 - the two-writer checkpoint is sequential and single-process
  ...
  - ID: 27.3-CR44
  - Status: open
  - Evidence: Story 27.2's `TwoServerWriters_ProduceUniqueRecordsWithoutCrossTenantMarkerMixupOrRawStorage` invokes two sanitizer instances sequentially in one process and performs no simultaneous state writes.
  - Source story: 27-3-production-adapter-and-deployment-profile (code review 2026-07-29, chunk 1 of 3)
  - Target artifact: tests/Hexalith.Memories.IntegrationTests/Telemetry/AccessTelemetryLifecycleIntegrationCheckpointTests.cs
...
### DW 27.3-CR45 - the outage checkpoint does not model a sixty-second outage
  ...
  - ID: 27.3-CR45
  - Status: open
  - Evidence: Story 27.2's `TemporarySixtySecondOutage_RecoversAndFiveMinuteRetryAgeStopsOldWork` scripts exactly one failure followed by success independently of the fake clock's elapsed time.
  - Source story: 27-3-production-adapter-and-deployment-profile (code review 2026-07-29, chunk 1 of 3)
  - Target artifact: tests/Hexalith.Memories.IntegrationTests/Telemetry/AccessTelemetryLifecycleIntegrationCheckpointTests.cs
...
### DW 27.3-CR46 - the least-privilege checkpoint parses YAML as formatting-sensitive text
  ...
  - ID: 27.3-CR46
  - Status: open
  - Evidence: Story 27.2's Kubernetes least-privilege checkpoint uses substring assertions; its short `appId: memories` positive match is also satisfied by the longer inspector application identifier.
  - Source story: 27-3-production-adapter-and-deployment-profile (code review 2026-07-29, chunk 1 of 3)
  - Target artifact: tests/Hexalith.Memories.IntegrationTests/Telemetry/AccessTelemetryLifecycleIntegrationCheckpointTests.cs
