...
- ID: MEM-7
  ...
  - Rationale: Architecture Decision D9 keeps the client concrete (no interface); residual gap is documenting the `HttpClient`-boundary mock seam and guaranteeing non-sealed/virtual stability, scheduled as Story 18.7. Adding `IMemoriesClient` was explicitly declined to honor D9.
