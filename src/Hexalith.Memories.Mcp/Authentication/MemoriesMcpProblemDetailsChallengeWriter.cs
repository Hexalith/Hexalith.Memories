// <copyright file="MemoriesMcpProblemDetailsChallengeWriter.cs" company="ITANEO">
...
/// <summary>Writes RFC 6750-compatible MCP authentication challenge responses.</summary>
internal static class MemoriesMcpProblemDetailsChallengeWriter
{
    ...
    {
        ChallengeKind.ExpiredToken => "The provided MCP bearer token has expired.",
        ChallengeKind.InvalidToken => "The provided MCP bearer token is invalid.",
        _ => "Bearer authentication is required to access the MCP endpoint.",
    };

    private static string GetWwwAuthenticateHeader(ChallengeKind kind) => kind switch
    {
        ChallengeKind.ExpiredToken => "Bearer realm=\"hexalith-memories-mcp\", error=\"invalid_token\", error_description=\"The token has expired\"",
        ChallengeKind.InvalidToken => "Bearer realm=\"hexalith-memories-mcp\", error=\"invalid_token\", error_description=\"The token is invalid\"",
        _ => "Bearer realm=\"hexalith-memories-mcp\"",
    };
