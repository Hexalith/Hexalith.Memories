...
3. **FR6 (Memory unit fully searchable across all axes after ingestion):** Forces the multi-backend consistency pattern (eventual consistency + compensation). Every ingestion must verify all three backends have the data.
