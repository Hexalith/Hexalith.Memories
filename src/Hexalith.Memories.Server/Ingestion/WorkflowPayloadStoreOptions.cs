...
/// <summary>Options for ingestion workflow claim-check payloads, including retained failed-source payloads.</summary>
public sealed class WorkflowPayloadStoreOptions
{
    ...
    /// <summary>Gets or sets the payload time-to-live in hours. Failed non-URL source payload references expire after this window.</summary>
