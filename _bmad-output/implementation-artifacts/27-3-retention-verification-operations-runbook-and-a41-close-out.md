...
- [ ] [Review][Patch] [High] Append the missing blocked `dev-story` ledger row for the recorded C0 attempt [_bmad-output/implementation-artifacts/27-3-retention-verification-operations-runbook-and-a41-close-out.md:258]
- [ ] [Review][Patch] [High] Map Story 27.2's live external discovery deltas before any Story 27.3 count agreement [_bmad-output/implementation-artifacts/27-3-retention-verification-operations-runbook-and-a41-close-out.md:173]
- [ ] [Review][Patch] [High] Prevent A41 mutation until Task 8 and every final validation gate pass [_bmad-output/implementation-artifacts/27-3-retention-verification-operations-runbook-and-a41-close-out.md:90]
- [ ] [Review][Patch] [High] Make every checkpoint command build fresh binaries and fail on zero discovery or execution [_bmad-output/implementation-artifacts/27-3-retention-verification-operations-runbook-and-a41-close-out.md:106]
- [ ] [Review][Patch] [High] Require every mandatory checkpoint to pass without an approved-skip escape hatch [_bmad-output/implementation-artifacts/27-3-retention-verification-operations-runbook-and-a41-close-out.md:89]
- [ ] [Review][Patch] [High] Keep C0 handoff repairs out of frozen task and planning sections [_bmad-output/implementation-artifacts/27-3-retention-verification-operations-runbook-and-a41-close-out.md:40]
- [ ] [Review][Patch] [High] Add required completion dates to the approved umbrella checkpoint table [_bmad-output/implementation-artifacts/27-3-retention-verification-operations-runbook-and-a41-close-out.md:104]
- [ ] [Review][Patch] [High] Classify the reverified runbook and dashboard test mechanics separately from anti-template Story 26.5 [_bmad-output/implementation-artifacts/27-3-retention-verification-operations-runbook-and-a41-close-out.md:111]
- [ ] [Review][Patch] [High] Define one canonical evidence matrix and closure anchor across C1-C6 and A41 records [_bmad-output/implementation-artifacts/27-3-retention-verification-operations-runbook-and-a41-close-out.md:112]
- [ ] [Review][Patch] [High] Add a close-out preflight, exact mutation set, postconditions, and recovery procedure [_bmad-output/implementation-artifacts/27-3-retention-verification-operations-runbook-and-a41-close-out.md:90]
- [ ] [Review][Patch] [High] Make discovery of every current A41 summary exhaustive and reproducible [_bmad-output/implementation-artifacts/27-3-retention-verification-operations-runbook-and-a41-close-out.md:91]
- [ ] [Review][Patch] [High] Verify purge interruption between record and index deletion across restart [_bmad-output/implementation-artifacts/27-3-retention-verification-operations-runbook-and-a41-close-out.md:63]
- [ ] [Review][Patch] [High] Revalidate the live component profile immediately before evidence-backed closure [_bmad-output/implementation-artifacts/27-3-retention-verification-operations-runbook-and-a41-close-out.md:89]
- [ ] [Review][Patch] [Medium] Make the creation-scope verifier assert monotonic status, unique YAML keys, artifact existence, status parity, and the 3/3 baseline-relative File List [_bmad-output/implementation-artifacts/tests/27-3-create-story-scope-evidence.md:51]
