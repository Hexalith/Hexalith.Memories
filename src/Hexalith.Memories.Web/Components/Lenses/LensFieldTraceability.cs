...
/// <c>Contracts.V1</c> contract does not yet expose — ingestion stage taxonomy, benchmark NDCG@10 scores
/// and thresholds, MCP transport metadata, freshness timestamps, last-checked times — record
/// <see cref="NoContractSource"/> and render a documented unavailable/insufficient-evidence boundary.
/// Those rows are the deferred follow-ups for Story 2.7 (see the story Dev Notes).</para>
/// <para>Because Story 2.7 is not yet <c>done</c>, this slice stays consume-only: the table never invents
/// new evidence, state, recovery, benchmark, activity, or MCP schema semantics.</para>
/// </remarks>
public static class LensFieldTraceability
{
    ...
    [
        ...
        new(LensKind.CaseActivityTrail, "activity.timestamp", NoContractSource, "ordering signal unavailable; deterministic by rank", Unit, "CaseActivityTrailMapperTests"),
        ...
        new(LensKind.IngestionLifecycleTracker, "ingestion.stage", NoContractSource, "stage unavailable; deferred to Story 2.7", Unit, "IngestionLifecycleMapperTests"),
        ...
        new(LensKind.OperatorHealthMatrix, "health.lastChecked", NoContractSource, "last-checked unavailable; deferred to Story 2.7", Unit, "OperatorHealthMatrixMapperTests"),
        ...
        new(LensKind.BenchmarkResultComparator, "benchmark.ndcg", NoContractSource, "benchmark evidence unavailable; deferred to Story 2.7", Bunit, "BenchmarkResultComparatorMapperTests"),
        new(LensKind.BenchmarkResultComparator, "benchmark.threshold", NoContractSource, "80% threshold status unavailable; not inferred in web layer", Unit, "BenchmarkResultComparatorMapperTests"),
        new(LensKind.BenchmarkResultComparator, "benchmark.perQuery", NoContractSource, "per-query breakdown unavailable; deferred to Story 2.7", Unit, "BenchmarkResultComparatorMapperTests"),
        new(LensKind.BenchmarkResultComparator, "benchmark.evidenceLink", NoContractSource, "reproducible evidence link unavailable", Unit, "BenchmarkResultComparatorMapperTests"),
        ...
        new(LensKind.AgentPacketInspector, "packet.toolName", NoContractSource, "tool/resource name unavailable; deferred to Story 2.7", Unit, "AgentPacketInspectorMapperTests"),
    ];
